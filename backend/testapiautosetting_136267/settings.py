"""
Django settings for testapiautosetting_136267 project.
...
ROOT_URLCONF = 'testapiautosetting_136267.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136267.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsb1ns6 Support <support@testapiautosetting-136267.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136267 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136267 App",
    "VERSION": "v1",
}
